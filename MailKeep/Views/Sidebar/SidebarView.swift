...
private extension IMAPAccount {
    static var mockPosteo: IMAPAccount {
        var a = IMAPAccount(label: "Posteo", host: "posteo.de", username: "11566519@posteo.com")
    ...
    static var mockKeffer: IMAPAccount {
        var a = IMAPAccount(label: "Keffer", host: "keffer.co", username: "hello@keffer.co")
...
#Preview {
    let state = AppState()
    state.accounts = [.mockPosteo, .mockKeffer]
